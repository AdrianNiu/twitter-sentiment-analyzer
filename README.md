...
In this demo, the user is a Verizon representative who interested in learning how people think about the brand and services. 
...
1. Create a new database named `primie_app` (or other names you preferred)
